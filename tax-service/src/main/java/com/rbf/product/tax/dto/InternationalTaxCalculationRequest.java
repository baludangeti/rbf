...
import com.rbf.product.tax.model.CustomerType;
import com.rbf.product.tax.model.TransactionType;
...
public class InternationalTaxCalculationRequest {
    private Long orgId;
    @NotBlank private String sellerCountry;
    private String sellerRegion;
    @NotBlank private String customerCountry;
    ...
    @NotNull @PositiveOrZero private BigDecimal discountAmount = BigDecimal.ZERO;
    @NotBlank private String currencyCode;
    @NotNull @Positive private BigDecimal exchangeRate = BigDecimal.ONE;
